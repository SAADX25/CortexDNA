    ...
    public partial class AboutWindow : Window
    {
        ...
        private void LoadVersionInfo()
        {
            try
            {
                ...
                var fullVersion = assembly?.GetCustomAttribute<AssemblyInformationalVersionAttribute>()?.InformationalVersion ?? "v1.3.5 all";
            ...
            {
                TxtMainVersion.Text = "Version: v1.3.5 all";
                TxtSubVersion.Visibility = Visibility.Collapsed;
            }
        }
